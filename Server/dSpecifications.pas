...
type
  TdmSpecifications = class(TDBPooledDataModule)
    ...
    qrySpecificationsMIN_ORDER_QUANTITY: TAbmesFloatField;
    qrySpecificationsMAX_ORDER_QUANTITY: TAbmesFloatField;
    qrySpecificationsSALE_ACQUIRE_SINGLE_PRICE: TAbmesFloatField;
    qrySpecificationsSALE_ACQUIRE_CURRENCY_ABBREV: TAbmesWideStringField;
    qrySpecificationsDLVR_ACQUIRE_SINGLE_PRICE: TAbmesFloatField;
    qrySpecificationsDLVR_ACQUIRE_CURRENCY_ABBREV: TAbmesWideStringField;
    qrySpecificationsINVESTMENT_LEVEL_1_SALE_PCT: TAbmesFloatField;
    qrySpecificationsINVESTMENT_LEVEL_1_DLVR_PCT: TAbmesFloatField;
    qrySpecificationsINVESTMENT_LEVEL_2_6_VALUE: TAbmesFloatField;
    qrySpecificationsINVESTMENT_LEVEL_2_6_SALE_PCT: TAbmesFloatField;
    qrySpecificationsINVESTMENT_LEVEL_2_6_DLVR_PCT: TAbmesFloatField;
    qrySpecificationsINVESTMENT_LEVEL_1_6_VALUE: TAbmesFloatField;
    qrySpecificationsINVESTMENT_LEVEL_1_6_SALE_PCT: TAbmesFloatField;

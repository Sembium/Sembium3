inherited dmStore: TdmStore
  ...
  object qryMovements: TAbmesSQLQuery
    ...
    SQL.Strings = (
      ...
      '  p.CUSTOM_CODE as PRODUCT_NO,'
      '  sd.BND_PROCESS_CODE,'
      '  proc.PROCESS_ABBREV as BND_PROCESS_ABBREV,'
      '  ('
      '    select'
      ...
      '  sd.DEPT_CODE,'
        ...
        '  (dt.DEPT_TYPE_ABBREV || d.CUSTOM_CODE || d.SUFFIX_LETTER) as W' +
        'ORK_DEPT_NAME,'
      '  sd.WORK_ORDER_NO,'
      '  (sd.QUANTITY * sd.IN_OUT) as QUANTITY,'
      '  mw.MEASURE_CODE as MEASURE_CODE,'
      '  mw.MEASURE_ABBREV as MEASURE_ABBREV,'
      '  (sd.ACCOUNT_QUANTITY * sd.IN_OUT) as ACCOUNT_QUANTITY,'
      '  ma.MEASURE_CODE as ACCOUNT_MEASURE_CODE,'
      ...
      '  sd.CREATE_EMPLOYEE_CODE,'
        ...
        '  (ce.FIRST_NAME || '#39' '#39'  || ce.LAST_NAME) as CREATE_EMPLOYEE_NAM' +
        'E,'
      '  sd.CREATE_DATE,'
      '  sd.CREATE_TIME,'
      ...
      '  sd.STORNO_EMPLOYEE_CODE,'
        ...
        '  (se.FIRST_NAME || '#39' '#39'  || se.LAST_NAME) as STORNO_EMPLOYEE_NAM' +
        'E,'
      '  sd.STORNO_DATE,'
      '  sd.STORNO_TIME,'
      ''
      ...
      'where'
      '  (sd.PRODUCT_CODE = p.PRODUCT_CODE) and'
      '  (sd.CREATE_EMPLOYEE_CODE = ce.EMPLOYEE_CODE(+)) and'
      '  (sd.STORNO_EMPLOYEE_CODE = se.EMPLOYEE_CODE(+)) and'
      '  (p.MEASURE_CODE = mw.MEASURE_CODE(+)) and'
      '  (p.ACCOUNT_MEASURE_CODE = ma.MEASURE_CODE(+)) and'
      '  (sd.BND_PROCESS_CODE = proc.PROCESS_CODE) and'
      '  (sd.DEPT_CODE = d.DEPT_CODE(+)) and'
      '  (sd.DEPT_CODE = ds.STORE_CODE(+)) and'
      '  (d.DEPT_TYPE_CODE = dt.DEPT_TYPE_CODE(+)) and'
      ''

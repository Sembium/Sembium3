inherited PrcDataReport: TPrcDataReport
  Functions.DATA = (
    '0'
    '0'
    #39#39
  ...
  inherited bndDetail: TQRBand
    ...
    inherited dbtNodeIdentifier: TQRDBText
      ...
      DataField = 'PRC_OBJECT_TREE_DISPLAY_NAME'
      FontSize = 10
    end
    ...
    object dbtPrcObjectName: TQRDBText [55]
      Left = 292
      Top = 1
      Width = 421
      Height = 17
  ...
  object PageHeaderBand1: TQRBand [2]
    Left = 38
    Top = 38
    Width = 718
    Height = 20

inherited rptXModelDocStatusModel: TrptXModelDocStatusModel
  Functions.DATA = (
    '0'
    '0'
    #39#39)
  ...
  inherited qrbTitle: TQRBand
    ...
    inherited lblReportTitle: TQRLabel
      ...
      AutoSize = True
      Caption = #1052#1072#1088#1096#1088#1091#1090#1085#1086' '#1052#1048#1048#1054' '#1085#1072' '#1056#1077#1076' '#1086#1090' '#1056'-'#1052#1054#1044#1045#1083' '#1085#1072
      Font.Height = -19
      FontSize = 14
      ExplicitWidth = 390
    end

...
type
  TfmPlannedStoreDealOut = class(TfmPlannedStoreDeal)
...
procedure TfmPlannedStoreDealOut.cdsDataNewRecord(DataSet: TDataSet);
begin
  inherited;

  cdsDataSTORE_DEAL_TYPE_CODE.AsInteger:= sdtOut;
end;

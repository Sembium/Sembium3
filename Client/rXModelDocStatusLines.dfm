inherited rptXModelDocStatusLines: TrptXModelDocStatusLines
  Functions.DATA = (
    '0'
    '0'
    #39#39)
  ...
  inherited qrbTitle: TQRBand
    ...
    inherited lblReportTitle: TQRLabel
      ...
      AutoSize = True
      Caption = #1052#1048#1048#1054' '#1085#1072' '#1056'-'#1052#1054#1044#1045#1083
      FontSize = 16
    end
    ...
    object QRDBText2: TQRDBText
      ...
      Color = clWhite
      DataSet = mdsParams
      DataField = '_PRINT_FIRST_LINE_STRUCT_COEF'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Arial'
